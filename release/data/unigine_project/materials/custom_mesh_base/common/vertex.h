 ...
 */
	...
	COMMON_OUT getCommon(COMMON_IN in_d) {
		...
		COMMON_OUT out_d;
			...
			in_d.position = mul4(patch_transf_row0, patch_transf_row1, patch_transf_row2, float4(in_d.position, 1.0f)).xyz;
		...
		float3 tangent,binormal,normal;
			...
			normal = normalize(mul3(patch_transf_row0, patch_transf_row1, patch_transf_row2, normal));
			tangent = normalize(mul3(patch_transf_row0, patch_transf_row1, patch_transf_row2, tangent));
			binormal = normalize(mul3(patch_transf_row0, patch_transf_row1, patch_transf_row2, binormal));
