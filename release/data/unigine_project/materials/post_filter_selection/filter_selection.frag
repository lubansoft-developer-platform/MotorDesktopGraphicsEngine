...
MAIN_BEGIN(FRAGMENT_OUT,FRAGMENT_IN)
	...
	float4 cAuxiColor = TEXTURE_BIAS_ZERO(TEX_AUXILIARY,uv);
	if(length(cAuxiColor) > EPSILON)
	{
		OUT_COLOR = float4(OUT_COLOR.rgb*0.8 + float3(0.0118f,0.9608f,0.9843f)*0.2f,1.f);
	}
	else
	{
