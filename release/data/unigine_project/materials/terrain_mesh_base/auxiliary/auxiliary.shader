...
#ifdef VERTEX
	#include <unigine_project/materials/terrain_mesh_base/common/vertex.h>
#elif FRAGMENT
	#include <unigine_project/materials/terrain_mesh_base/common/fragment.h>
#endif
...
MAIN_BEGIN_VERTEX(FRAGMENT_IN)
	...
	#include <unigine_project/materials/terrain_mesh_base/common/vertex.h>
	#ifdef BOARDMASK
		if (fDepthPosition.a <= 0 || fBoardId.g <= 0 || cVertex.z < fDepthPosition.r || cVertex.z > (fDepthPosition.r + fDepthPosition.g))
		{
			f_discard = 1.f;
		}
		else
